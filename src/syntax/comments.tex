...
You can use the \code{rustdoc} tool to generate HTML documentation from these doc comments, and also to run the code examples as tests
(see \nameref{sec:effective_documentation})!
