...
\subsubsection*{Recursive macros}
...
\subsubsection*{Debugging macro code}
...
\subsubsection*{The variable \code{\$crate}}
...
% TODO make compiler plugins a hyperref
If Rust's macro system can't do what you need, you may want to write a compiler plugin instead. Compared to \code{macro\_rules!} macros, 
