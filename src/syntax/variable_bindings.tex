...
\nameref{sec:syntax_patterns}). This means we can do things like:
...
own section in the book (see \nameref{sec:syntax_patterns}). We don't need those features for now, so we'll keep this in the back 
